    ...
    try:
        ...
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius:16px; padding:24px; margin-bottom:24px; box-shadow: 0 8px 32px rgba(0,0,0,0.12); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;'>
            <div style='display: flex; align-items: center; margin-bottom: 20px;'>
                <div style='width: 12px; height: 12px; background: #fff; border-radius: 50%; margin-right: 12px; opacity: 0.9;'></div>
                <h2 style='color: #fff; font-size: 20px; font-weight: 600; margin: 0; letter-spacing: -0.5px;'>Processing Summary</h2>
            </div>
            <div style='display: flex; gap: 16px; flex-wrap: wrap;'>
                <div style='background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: 12px; padding: 16px; flex: 1; min-width: 120px; border: 1px solid rgba(255,255,255,0.2);'>
        ...
        <div style='background: #fff; border-radius: 16px; padding: 28px; margin-bottom: 24px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.05); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;'>
            <div style='display: flex; align-items: center; margin-bottom: 20px;'>
                <div style='width: 40px; height: 40px; background: linear-gradient(135deg, #4F46E5, #7C3AED); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-right: 16px;'>
                    <div style='color: #fff; font-size: 18px; font-weight: bold;'>📊</div>
                </div>
                <h2 style='color: #1F2937; font-size: 24px; font-weight: 700; margin: 0; letter-spacing: -0.5px;'>Market Overview</h2>
            </div>
        ...
        if anomalies_str:
            ...
            <div style='background: #fff; border-radius: 16px; padding: 28px; margin-bottom: 24px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.05); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;'>
                <div style='display: flex; align-items: center; margin-bottom: 24px;'>
                    <div style='width: 40px; height: 40px; background: linear-gradient(135deg, #F59E0B, #F97316); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-right: 16px;'>
        ...
        # ---- Modern HTML Body with Dark Mode Support ----
        html_body = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
